...
The Designing Tool For the purpose of this take-home exercise, ggplot2 and its extension should be used to design the analytical visualisation. tidyverse family of packages should be used to prepare the data.

The Write-up The write-up of the take-home exercise should include but not limited to the followings:
