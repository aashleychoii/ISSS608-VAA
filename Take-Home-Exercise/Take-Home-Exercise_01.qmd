...
Selected 9 areas can be grouped by similar sub-categories as per their location and geographic characteristics -- Town (Downtown Core, Newton), West (Bukit Timah, Clementi), North-East (Serangoon,
Hougang), East (Tampines, Changi), and North (Sembawang).
